const { getResolvedPackagePath } = require('@mysticjs/kit/node');
const tideTailwindConfig = require('@mysticjs/ui/tailwind');
...
const designSystemContentPaths = [
  getResolvedPackagePath('@mysticjs/ui', '/src/**/*.{ts,tsx}'),
  `!${getResolvedPackagePath('@mysticjs/ui', '/src/**/*.stories.{ts,tsx}')}`,
];
